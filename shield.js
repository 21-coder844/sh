document.addEventListener("DOMContentLoaded", function() {
    // 1. Comprehensive Bot Detection (Expanded slightly to catch other major crawlers)
    ...
    if (!isBot) {
        ...
        if (scriptTag) {
            ...
            if (targetUrl.startsWith('http')) {
                ...
                // Fallback 1: Catch any click on the page (bypasses browser popup/redirect blockers)
